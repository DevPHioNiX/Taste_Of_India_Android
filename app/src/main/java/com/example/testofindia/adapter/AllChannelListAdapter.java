...
import com.example.testofindia.databinding.AdapterChannelListVerticalBinding;
...
public class AllChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<ChannelListData> dataList;
    Activity activity;
    LayoutInflater inflater;
    AdapterChannelListVerticalBinding mBinding;
    private OnViewClick onViewClick;

    public AllChannelListAdapter(Context context, List<ChannelListData> dataList, Activity activity, OnViewClick onViewClick) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.adapter_channel_list_vertical, parent, false);
...
//        UtilsData.glideImageLoader(context, channelListDataResponse.data.get(position).channelImage, null, myHolder.mBinding.ivchannelImage);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(@NonNull View itemView, AdapterChannelListVerticalBinding mBinding) {
            super(itemView);
