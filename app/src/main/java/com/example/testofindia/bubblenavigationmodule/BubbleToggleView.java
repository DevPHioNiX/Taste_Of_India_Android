...
import com.example.testofindia.bubblenavigationmodule.util.ViewUtils;
...
public class BubbleToggleView extends RelativeLayout
{
    ...
    private void init(Context context, @Nullable AttributeSet attrs) {
        ...
        int colorInactive = ContextCompat.getColor(context, R.color.text_color);
        float titleSize = context.getResources().getDimension(R.dimen.size_14sp);
        maxTitleWidth = context.getResources().getDimension(R.dimen.size_80dp);
        float iconWidth = context.getResources().getDimension(R.dimen.size_24sp);
        float iconHeight = context.getResources().getDimension(R.dimen.size_24sp);
        int internalPadding = (int) context.getResources().getDimension(R.dimen.size_12dp);
        int titlePadding = (int) context.getResources().getDimension(R.dimen.size_8dp);

        int badgeTextSize = (int) context.getResources().getDimension(R.dimen.size_7dp);
        int badgeBackgroundColor = ContextCompat.getColor(context, R.color.colorPrimary);
        int badgeTextColor = ContextCompat.getColor(context, R.color.text_color_white);
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    ...
                    icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_bt_icon, R.drawable.ic_home_icon));
        ...
        if (icon == null)
            icon = ContextCompat.getDrawable(context, R.drawable.ic_home_icon);
    ...
    private void updateBadge(Context context) {
        ...
        int badgePadding = (int) context.getResources().getDimension(R.dimen.size_2dp);
        //update the margin of the text view
